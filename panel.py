...
class Panel:
    ...
    def draw(self, time, coordinates, obj_coordinates) -> pygame.Surface:
        ...
        self.surface.blit(font.render(f"object coordinates: {obj_coordinates}", True, (255, 255, 255)), (0, 2*font.get_height()))
